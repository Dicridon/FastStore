...
TEST_INDEXING_DEP=$(SRC_TEST_INDEXING) $(HDR_TEST_INDEXING) $(INDEXING_INDEXING_DEP) $(WORKLOAD_WORKLOAD_DEP)
...
$(TEST_INDEXING): $(OBJ_TEST_INDEXING) $(OBJ_INDEXING_INDEXING) $(OBJ_WORKLOAD_WORKLOAD) $(OBJ_MEMORY_MANAGER_MEMORY_MANAGER) $(OBJ_REMOTE_MEMORY_REMOTE_MEMORY) $(OBJ_WAL_WAL) $(OBJ_KV_PAIR_KV_PAIR) $(OBJ_MISC_MISC) $(OBJ_COLORING_COLORING) $(OBJ_CONFIG_CONFIG) $(OBJ_RDMA_RDMA) $(OBJ_CLUSTER_CLUSTER)
	$(CXX) $(CXXFLAGS) -o $@ $^ $(LDFLAGS) $(LDLIBS)
