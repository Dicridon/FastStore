CXX=clang++
CXXFLAGS=-O0 -g -std=c++17 -Wall -Ithird-party/eRPC/src -I./src/components
LDFLAGS=-Lthird-party/eRPC/build
...
REMOTE_MEMORY_REMOTE_MEMORY_DEP=$(SRC_REMOTE_MEMORY_REMOTE_MEMORY) $(HDR_REMOTE_MEMORY_REMOTE_MEMORY) $(RDMA_RDMA_DEP) $(MISC_MISC_DEP)
