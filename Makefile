...
MAIN_DEP=$(SRC_MAIN)
INDEXING_INDEXING_DEP=$(SRC_INDEXING_INDEXING) $(HDR_INDEXING_INDEXING) $(REMOTE_MEMORY_REMOTE_MEMORY_DEP) $(WAL_WAL_DEP) $(KV_PAIR_KV_PAIR_DEP) $(COLORING_COLORING_DEP) $(DEBUG_LOGGER_DEBUG_LOGGER_DEP)
...
STORE_STORE_DEP=$(SRC_STORE_STORE) $(HDR_STORE_STORE) $(INDEXING_INDEXING_DEP) $(READ_CACHE_READ_CACHE_DEP) $(ENGINE_ENGINE_DEP) $(RPC_WRAPPER_RPC_WRAPPER_DEP) $(WORKLOAD_WORKLOAD_DEP) $(CITY_CITY_DEP) $(STATS_STATS_DEP)
...
TEST_CACHE_DEP=$(SRC_TEST_CACHE) $(HDR_TEST_CACHE) $(CMD_PARSER_CMD_PARSER_DEP) $(READ_CACHE_READ_CACHE_DEP)
...
$(TEST_CACHE): $(OBJ_TEST_CACHE) $(OBJ_CMD_PARSER_CMD_PARSER) $(OBJ_READ_CACHE_READ_CACHE) $(OBJ_MEMORY_MANAGER_MEMORY_MANAGER) $(OBJ_KV_PAIR_KV_PAIR) $(OBJ_REMOTE_MEMORY_REMOTE_MEMORY) $(OBJ_CONFIG_CONFIG) $(OBJ_RDMA_RDMA) $(OBJ_MISC_MISC) $(OBJ_CLUSTER_CLUSTER)
...
$(TEST_INDEXING): $(OBJ_TEST_INDEXING) $(OBJ_INDEXING_INDEXING) $(OBJ_WORKLOAD_WORKLOAD) $(OBJ_CMD_PARSER_CMD_PARSER) $(OBJ_MEMORY_MANAGER_MEMORY_MANAGER) $(OBJ_REMOTE_MEMORY_REMOTE_MEMORY) $(OBJ_WAL_WAL) $(OBJ_KV_PAIR_KV_PAIR) $(OBJ_MISC_MISC) $(OBJ_COLORING_COLORING) $(OBJ_DEBUG_LOGGER_DEBUG_LOGGER) $(OBJ_CONFIG_CONFIG) $(OBJ_RDMA_RDMA) $(OBJ_CLUSTER_CLUSTER)
	$(CXX) $(CXXFLAGS) -o $@ $^ $(LDFLAGS) $(LDLIBS)
