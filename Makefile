...
TEST_ENGINE_DEP=$(SRC_TEST_ENGINE) $(HDR_TEST_ENGINE) $(ENGINE_ENGINE_DEP)
...
$(TEST_ENGINE): $(OBJ_TEST_ENGINE) $(OBJ_ENGINE_ENGINE) $(OBJ_WAL_WAL) $(OBJ_MEMORY_MANAGER_MEMORY_MANAGER) $(OBJ_REMOTE_MEMORY_REMOTE_MEMORY) $(OBJ_CLUSTER_CLUSTER) $(OBJ_RDMA_RDMA) $(OBJ_MISC_MISC)
	$(CXX) $(CXXFLAGS) -o $@ $^ $(LDFLAGS) $(LDLIBS)
