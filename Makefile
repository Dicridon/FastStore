...
TESTS=$(TEST_CACHE) $(TEST_MEMORY_MANAGER) $(TEST_POLYMORPHIC_POINTER) $(TEST_COLORING) $(TEST_WORKLOAD) $(TEST_WAL) $(TEST_STATS) $(TEST_DEBUG_LOGGER) $(TEST_CMD_PARSER) $(TEST_RDMA) $(TEST_KV_PAIR) $(TEST_STORE) $(TEST_ERPC) $(TEST_ENGINE) $(TEST_SERVER) $(TEST_CLUSTER) $(TEST_STRING) $(TEST_INDEXING) $(TEST_MISC) $(TEST_REMOTE_POINTER)
