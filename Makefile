...
TEST_OBJS=$(OBJ_TESTS_TESTS) $(OBJ_TEST_CACHE) $(OBJ_TEST_MEMORY_MANAGER) $(OBJ_TEST_POLYMORPHIC_POINTER) $(OBJ_TEST_COLORING) $(OBJ_TEST_WORKLOAD) $(OBJ_TEST_WAL) $(OBJ_TEST_DEBUG_LOGGER) $(OBJ_TEST_CMD_PARSER) $(OBJ_TEST_RDMA) $(OBJ_TEST_KV_PAIR) $(OBJ_TEST_STORE) $(OBJ_TEST_ERPC) $(OBJ_TEST_ENGINE) $(OBJ_TEST_SERVER) $(OBJ_TEST_CLUSTER) $(OBJ_TEST_STRING) $(OBJ_TEST_INDEXING) $(OBJ_TEST_MISC) $(OBJ_TEST_REMOTE_POINTER)
...
TESTS=$(TEST_CACHE) $(TEST_MEMORY_MANAGER) $(TEST_POLYMORPHIC_POINTER) $(TEST_COLORING) $(TEST_WORKLOAD) $(TEST_WAL) $(TEST_DEBUG_LOGGER) $(TEST_CMD_PARSER) $(TEST_RDMA) $(TEST_KV_PAIR) $(TEST_STORE) $(TEST_ERPC) $(TEST_ENGINE) $(TEST_SERVER) $(TEST_CLUSTER) $(TEST_STRING) $(TEST_INDEXING) $(TEST_MISC) $(TEST_REMOTE_POINTER)
...
STORE_STORE_DEP=$(SRC_STORE_STORE) $(HDR_STORE_STORE) $(INDEXING_INDEXING_DEP) $(READ_CACHE_READ_CACHE_DEP) $(ENGINE_ENGINE_DEP) $(RPC_WRAPPER_RPC_WRAPPER_DEP) $(WORKLOAD_WORKLOAD_DEP) $(CITY_CITY_DEP)
