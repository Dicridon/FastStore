...
OUT_OBJS=$(OBJ_HILL) $(OBJ_MAIN) $(OBJ_INDEXING_INDEXING) $(OBJ_COLORING_COLORING) $(OBJ_RPC_WRAPPER_RPC_WRAPPER) $(OBJ_KV_PAIR_KV_PAIR) $(OBJ_WAL_WAL) $(OBJ_CMD_PARSER_CMD_PARSER) $(OBJ_REMOTE_MEMORY_REMOTE_MEMORY) $(OBJ_RDMA_RDMA) $(OBJ_CLUSTER_CLUSTER) $(OBJ_MEMORY_MANAGER_MEMORY_MANAGER) $(OBJ_STORE_STORE) $(OBJ_READ_CACHE_READ_CACHE) $(OBJ_ENGINE_ENGINE) $(OBJ_MISC_MISC)
TEST_OBJS=$(OBJ_TESTS_TESTS) $(OBJ_TEST_CACHE) $(OBJ_TEST_MEMORY_MANAGER) $(OBJ_TEST_POLYMORPHIC_POINTER) $(OBJ_TEST_COLORING) $(OBJ_TEST_WAL) $(OBJ_TEST_CMD_PARSER) $(OBJ_TEST_RDMA) $(OBJ_TEST_KV_PAIR) $(OBJ_TEST_STORE) $(OBJ_TEST_ERPC) $(OBJ_TEST_ENGINE) $(OBJ_TEST_CLUSTER) $(OBJ_TEST_STRING) $(OBJ_TEST_INDEXING) $(OBJ_TEST_MISC) $(OBJ_TEST_REMOTE_POINTER)
...
TESTS=$(TEST_CACHE) $(TEST_MEMORY_MANAGER) $(TEST_POLYMORPHIC_POINTER) $(TEST_COLORING) $(TEST_WAL) $(TEST_CMD_PARSER) $(TEST_RDMA) $(TEST_KV_PAIR) $(TEST_STORE) $(TEST_ERPC) $(TEST_ENGINE) $(TEST_CLUSTER) $(TEST_STRING) $(TEST_INDEXING) $(TEST_MISC) $(TEST_REMOTE_POINTER)
...
STORE_STORE_DEP=$(SRC_STORE_STORE) $(HDR_STORE_STORE) $(INDEXING_INDEXING_DEP) $(READ_CACHE_READ_CACHE_DEP) $(ENGINE_ENGINE_DEP) $(RPC_WRAPPER_RPC_WRAPPER_DEP)
...
TEST_STORE_DEP=$(SRC_TEST_STORE) $(HDR_TEST_STORE) $(STORE_STORE_DEP)
TEST_ERPC_DEP=$(SRC_TEST_ERPC) $(HDR_TEST_ERPC) $(RPC_WRAPPER_RPC_WRAPPER_DEP)
...
$(TEST_POLYMORPHIC_POINTER): $(OBJ_TEST_POLYMORPHIC_POINTER) $(OBJ_REMOTE_MEMORY_REMOTE_MEMORY) $(OBJ_MEMORY_MANAGER_MEMORY_MANAGER) $(OBJ_RDMA_RDMA) $(OBJ_MISC_MISC) $(OBJ_CLUSTER_CLUSTER)
	$(CXX) $(CXXFLAGS) -o $@ $^ $(LDFLAGS) $(LDLIBS)
...
$(TEST_RDMA): $(OBJ_TEST_RDMA) $(OBJ_RDMA_RDMA) $(OBJ_COLORING_COLORING) $(OBJ_CMD_PARSER_CMD_PARSER) $(OBJ_MISC_MISC) $(OBJ_MEMORY_MANAGER_MEMORY_MANAGER)
	$(CXX) $(CXXFLAGS) -o $@ $^ $(LDFLAGS) $(LDLIBS)

$(TEST_KV_PAIR): $(OBJ_TEST_KV_PAIR) $(OBJ_KV_PAIR_KV_PAIR) $(OBJ_MEMORY_MANAGER_MEMORY_MANAGER)
	$(CXX) $(CXXFLAGS) -o $@ $^ $(LDFLAGS) $(LDLIBS)

$(TEST_STORE): $(OBJ_TEST_STORE) $(OBJ_STORE_STORE) $(OBJ_INDEXING_INDEXING) $(OBJ_REMOTE_MEMORY_REMOTE_MEMORY) $(OBJ_MEMORY_MANAGER_MEMORY_MANAGER) $(OBJ_READ_CACHE_READ_CACHE) $(OBJ_ENGINE_ENGINE) $(OBJ_RPC_WRAPPER_RPC_WRAPPER) $(OBJ_KV_PAIR_KV_PAIR) $(OBJ_WAL_WAL) $(OBJ_MISC_MISC) $(OBJ_COLORING_COLORING) $(OBJ_RDMA_RDMA) $(OBJ_CLUSTER_CLUSTER)
	$(CXX) $(CXXFLAGS) -o $@ $^ $(LDFLAGS) $(LDLIBS)

$(TEST_ERPC): $(OBJ_TEST_ERPC) $(OBJ_RPC_WRAPPER_RPC_WRAPPER)
	$(CXX) $(CXXFLAGS) -o $@ $^ $(LDFLAGS) $(LDLIBS)
...
$(TEST_STRING): $(OBJ_TEST_STRING) $(OBJ_KV_PAIR_KV_PAIR) $(OBJ_MEMORY_MANAGER_MEMORY_MANAGER)
	$(CXX) $(CXXFLAGS) -o $@ $^ $(LDFLAGS) $(LDLIBS)

$(TEST_INDEXING): $(OBJ_TEST_INDEXING) $(OBJ_INDEXING_INDEXING) $(OBJ_MEMORY_MANAGER_MEMORY_MANAGER) $(OBJ_REMOTE_MEMORY_REMOTE_MEMORY) $(OBJ_WAL_WAL) $(OBJ_KV_PAIR_KV_PAIR) $(OBJ_MISC_MISC) $(OBJ_COLORING_COLORING) $(OBJ_RDMA_RDMA) $(OBJ_CLUSTER_CLUSTER)
	$(CXX) $(CXXFLAGS) -o $@ $^ $(LDFLAGS) $(LDLIBS)

$(TEST_MISC): $(OBJ_TEST_MISC) $(OBJ_MISC_MISC) $(OBJ_CMD_PARSER_CMD_PARSER)
	$(CXX) $(CXXFLAGS) -o $@ $^ $(LDFLAGS) $(LDLIBS)

$(TEST_REMOTE_POINTER): $(OBJ_TEST_REMOTE_POINTER) $(OBJ_REMOTE_MEMORY_REMOTE_MEMORY) $(OBJ_MEMORY_MANAGER_MEMORY_MANAGER) $(OBJ_RDMA_RDMA) $(OBJ_MISC_MISC) $(OBJ_CLUSTER_CLUSTER)
	$(CXX) $(CXXFLAGS) -o $@ $^ $(LDFLAGS) $(LDLIBS)
