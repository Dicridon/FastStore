...
CLUSTER_CLUSTER_DEP=$(SRC_CLUSTER_CLUSTER) $(HDR_CLUSTER_CLUSTER) $(MEMORY_MANAGER_MEMORY_MANAGER_DEP) $(MISC_MISC_DEP) $(CONFIG_CONFIG_DEP)
...
$(TEST_INDEXING): $(OBJ_TEST_INDEXING) $(OBJ_INDEXING_INDEXING) $(OBJ_MEMORY_MANAGER_MEMORY_MANAGER) $(OBJ_REMOTE_MEMORY_REMOTE_MEMORY) $(OBJ_WAL_WAL) $(OBJ_KV_PAIR_KV_PAIR) $(OBJ_MISC_MISC) $(OBJ_COLORING_COLORING) $(OBJ_RDMA_RDMA) $(OBJ_CLUSTER_CLUSTER) $(OBJ_CONFIG_CONFIG)
	$(CXX) $(CXXFLAGS) -o $@ $^ $(LDFLAGS) $(LDLIBS)
