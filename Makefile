...
OUT_OBJS=$(OBJ_HILL) $(OBJ_MAIN) $(OBJ_INDEXING_INDEXING) $(OBJ_COLORING_COLORING) $(OBJ_RPC_WRAPPER_RPC_WRAPPER) $(OBJ_KV_PAIR_KV_PAIR) $(OBJ_STATS_STATS) $(OBJ_CITY_CITY) $(OBJ_WAL_WAL) $(OBJ_CMD_PARSER_CMD_PARSER) $(OBJ_REMOTE_MEMORY_REMOTE_MEMORY) $(OBJ_RDMA_RDMA) $(OBJ_CLUSTER_CLUSTER) $(OBJ_MEMORY_MANAGER_MEMORY_MANAGER) $(OBJ_CONFIG_CONFIG) $(OBJ_STORE_STORE) $(OBJ_READ_CACHE_READ_CACHE) $(OBJ_ENGINE_ENGINE) $(OBJ_CONFIG_READER_CONFIG_READER) $(OBJ_WORKLOAD_WORKLOAD) $(OBJ_MISC_MISC) $(OBJ_DEBUG_LOGGER_DEBUG_LOGGER)
TEST_OBJS=$(OBJ_TESTS_TESTS) $(OBJ_TEST_CACHE) $(OBJ_TEST_MEMORY_MANAGER) $(OBJ_TEST_POLYMORPHIC_POINTER) $(OBJ_TEST_COLORING) $(OBJ_TEST_WORKLOAD) $(OBJ_TEST_WAL) $(OBJ_TEST_STATS) $(OBJ_TEST_DEBUG_LOGGER) $(OBJ_TEST_CMD_PARSER) $(OBJ_TEST_RDMA) $(OBJ_TEST_KV_PAIR) $(OBJ_TEST_STORE) $(OBJ_TEST_ERPC) $(OBJ_TEST_ENGINE) $(OBJ_TEST_SERVER) $(OBJ_TEST_CLUSTER) $(OBJ_TEST_STRING) $(OBJ_TEST_INDEXING) $(OBJ_TEST_CITY) $(OBJ_TEST_MISC) $(OBJ_TEST_REMOTE_POINTER)
...
TESTS=$(TEST_CACHE) $(TEST_MEMORY_MANAGER) $(TEST_POLYMORPHIC_POINTER) $(TEST_COLORING) $(TEST_WORKLOAD) $(TEST_WAL) $(TEST_STATS) $(TEST_DEBUG_LOGGER) $(TEST_CMD_PARSER) $(TEST_RDMA) $(TEST_KV_PAIR) $(TEST_STORE) $(TEST_ERPC) $(TEST_ENGINE) $(TEST_SERVER) $(TEST_CLUSTER) $(TEST_STRING) $(TEST_INDEXING) $(TEST_CITY) $(TEST_MISC) $(TEST_REMOTE_POINTER)
...
STORE_STORE_DEP=$(SRC_STORE_STORE) $(HDR_STORE_STORE) $(INDEXING_INDEXING_DEP) $(READ_CACHE_READ_CACHE_DEP) $(ENGINE_ENGINE_DEP) $(RPC_WRAPPER_RPC_WRAPPER_DEP) $(WORKLOAD_WORKLOAD_DEP) $(STATS_STATS_DEP)
...
$(TEST_CACHE): $(OBJ_TEST_CACHE) $(OBJ_CMD_PARSER_CMD_PARSER) $(OBJ_READ_CACHE_READ_CACHE) $(OBJ_WORKLOAD_WORKLOAD) $(OBJ_MEMORY_MANAGER_MEMORY_MANAGER) $(OBJ_KV_PAIR_KV_PAIR) $(OBJ_REMOTE_MEMORY_REMOTE_MEMORY) $(OBJ_CONFIG_CONFIG) $(OBJ_RDMA_RDMA) $(OBJ_MISC_MISC) $(OBJ_CLUSTER_CLUSTER) $(OBJ_CONFIG_READER_CONFIG_READER)
	$(CXX) $(CXXFLAGS) -o $@ $^ $(LDFLAGS) $(LDLIBS)

$(TEST_MEMORY_MANAGER): $(OBJ_TEST_MEMORY_MANAGER) $(OBJ_MEMORY_MANAGER_MEMORY_MANAGER) $(OBJ_CONFIG_CONFIG)
	$(CXX) $(CXXFLAGS) -o $@ $^ $(LDFLAGS) $(LDLIBS)

$(TEST_POLYMORPHIC_POINTER): $(OBJ_TEST_POLYMORPHIC_POINTER) $(OBJ_REMOTE_MEMORY_REMOTE_MEMORY) $(OBJ_MEMORY_MANAGER_MEMORY_MANAGER) $(OBJ_RDMA_RDMA) $(OBJ_MISC_MISC) $(OBJ_CLUSTER_CLUSTER) $(OBJ_CONFIG_CONFIG) $(OBJ_CONFIG_READER_CONFIG_READER)
	$(CXX) $(CXXFLAGS) -o $@ $^ $(LDFLAGS) $(LDLIBS)
...
$(TEST_STORE): $(OBJ_TEST_STORE) $(OBJ_STORE_STORE) $(OBJ_CMD_PARSER_CMD_PARSER) $(OBJ_INDEXING_INDEXING) $(OBJ_REMOTE_MEMORY_REMOTE_MEMORY) $(OBJ_MEMORY_MANAGER_MEMORY_MANAGER) $(OBJ_READ_CACHE_READ_CACHE) $(OBJ_ENGINE_ENGINE) $(OBJ_RPC_WRAPPER_RPC_WRAPPER) $(OBJ_KV_PAIR_KV_PAIR) $(OBJ_WORKLOAD_WORKLOAD) $(OBJ_CONFIG_CONFIG) $(OBJ_CITY_CITY) $(OBJ_STATS_STATS) $(OBJ_WAL_WAL) $(OBJ_MISC_MISC) $(OBJ_COLORING_COLORING) $(OBJ_DEBUG_LOGGER_DEBUG_LOGGER) $(OBJ_RDMA_RDMA) $(OBJ_CLUSTER_CLUSTER) $(OBJ_CONFIG_READER_CONFIG_READER)
	$(CXX) $(CXXFLAGS) -o $@ $^ $(LDFLAGS) $(LDLIBS)

$(TEST_ERPC): $(OBJ_TEST_ERPC) $(OBJ_CMD_PARSER_CMD_PARSER) $(OBJ_RPC_WRAPPER_RPC_WRAPPER)
	$(CXX) $(CXXFLAGS) -o $@ $^ $(LDFLAGS) $(LDLIBS)

$(TEST_ENGINE): $(OBJ_TEST_ENGINE) $(OBJ_ENGINE_ENGINE) $(OBJ_CMD_PARSER_CMD_PARSER) $(OBJ_WAL_WAL) $(OBJ_MEMORY_MANAGER_MEMORY_MANAGER) $(OBJ_REMOTE_MEMORY_REMOTE_MEMORY) $(OBJ_CLUSTER_CLUSTER) $(OBJ_RDMA_RDMA) $(OBJ_MISC_MISC) $(OBJ_CONFIG_READER_CONFIG_READER) $(OBJ_CONFIG_CONFIG)
	$(CXX) $(CXXFLAGS) -o $@ $^ $(LDFLAGS) $(LDLIBS)

$(TEST_SERVER): $(OBJ_TEST_SERVER) $(OBJ_ENGINE_ENGINE) $(OBJ_INDEXING_INDEXING) $(OBJ_WAL_WAL) $(OBJ_CMD_PARSER_CMD_PARSER) $(OBJ_WORKLOAD_WORKLOAD) $(OBJ_KV_PAIR_KV_PAIR) $(OBJ_MEMORY_MANAGER_MEMORY_MANAGER) $(OBJ_REMOTE_MEMORY_REMOTE_MEMORY) $(OBJ_CLUSTER_CLUSTER) $(OBJ_RDMA_RDMA) $(OBJ_MISC_MISC) $(OBJ_CONFIG_READER_CONFIG_READER) $(OBJ_CONFIG_CONFIG) $(OBJ_COLORING_COLORING) $(OBJ_DEBUG_LOGGER_DEBUG_LOGGER) $(OBJ_CITY_CITY)
	$(CXX) $(CXXFLAGS) -o $@ $^ $(LDFLAGS) $(LDLIBS)

$(TEST_CLUSTER): $(OBJ_TEST_CLUSTER) $(OBJ_CLUSTER_CLUSTER) $(OBJ_MISC_MISC) $(OBJ_CMD_PARSER_CMD_PARSER) $(OBJ_MEMORY_MANAGER_MEMORY_MANAGER) $(OBJ_CONFIG_CONFIG) $(OBJ_CONFIG_READER_CONFIG_READER)
	$(CXX) $(CXXFLAGS) -o $@ $^ $(LDFLAGS) $(LDLIBS)

$(TEST_STRING): $(OBJ_TEST_STRING) $(OBJ_KV_PAIR_KV_PAIR) $(OBJ_MEMORY_MANAGER_MEMORY_MANAGER) $(OBJ_CONFIG_CONFIG)
	$(CXX) $(CXXFLAGS) -o $@ $^ $(LDFLAGS) $(LDLIBS)

$(TEST_INDEXING): $(OBJ_TEST_INDEXING) $(OBJ_INDEXING_INDEXING) $(OBJ_WORKLOAD_WORKLOAD) $(OBJ_CMD_PARSER_CMD_PARSER) $(OBJ_MEMORY_MANAGER_MEMORY_MANAGER) $(OBJ_REMOTE_MEMORY_REMOTE_MEMORY) $(OBJ_WAL_WAL) $(OBJ_KV_PAIR_KV_PAIR) $(OBJ_MISC_MISC) $(OBJ_COLORING_COLORING) $(OBJ_DEBUG_LOGGER_DEBUG_LOGGER) $(OBJ_CITY_CITY) $(OBJ_CONFIG_CONFIG) $(OBJ_RDMA_RDMA) $(OBJ_CLUSTER_CLUSTER) $(OBJ_CONFIG_READER_CONFIG_READER)
	$(CXX) $(CXXFLAGS) -o $@ $^ $(LDFLAGS) $(LDLIBS)
...
$(TEST_REMOTE_POINTER): $(OBJ_TEST_REMOTE_POINTER) $(OBJ_REMOTE_MEMORY_REMOTE_MEMORY) $(OBJ_MEMORY_MANAGER_MEMORY_MANAGER) $(OBJ_RDMA_RDMA) $(OBJ_MISC_MISC) $(OBJ_CLUSTER_CLUSTER) $(OBJ_CONFIG_CONFIG) $(OBJ_CONFIG_READER_CONFIG_READER)
	$(CXX) $(CXXFLAGS) -o $@ $^ $(LDFLAGS) $(LDLIBS)
